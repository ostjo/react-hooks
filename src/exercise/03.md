...
When deciding where to place state, there's two main principles in React:

> ⬆️ **Lifting state**<br/> Handle state management in the lowest common parent

> ⬇️ **Colocating state**<br/> Push state back down – generally speaking: as
> close to where it's relevant as possible

Here's a super nice
[flow chart](https://kentcdodds.com/blog/state-colocation-will-make-your-react-app-faster#so-how-do-you-decide-where-to-put-state)
that can help when deciding where to place and how to propagate state.
